...
2. You record your desktop screen (mp4/mov files) and perform several clicks on this webpage.
...
3. Open a device and navigate to: https://yossidar.github.io/latency-test/, Record your clickings (record the desktop)
4. Download latency.py.
5. Put the recorded video in the same folder (for simplicity).
6. Run: python .\latency.py .\record.mp4
